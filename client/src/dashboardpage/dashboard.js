...
function Dashboard() {
  return (
    <div>
      ...
      <Link to="/Lesson" className={ window.location.pathname === "/" || window.location.pathname === "/about" ? "nav-link active" : "nav-link" } >
      ...
      <Link to="/Result" className={ window.location.pathname === "/" || window.location.pathname === "/about" ? "nav-link active" : "nav-link" } >
      <div class="circle-tile ">
          <a href="#">
